...
const About = () => {
  ...
  return (
    <>
      <div className={styles.head}>FX収支データを管理し、取引分析を行うアプリ</div>
      ...
      <div>２．証券会社(YJFX)から出力される全取引CSVデータを加工し表示</div>
      ...
      <div>検討：FXのAPIを取得しZarチャートに取引履歴を表示？？</div> */}
      ...
      <div className={styles.button}>
        <a
          href={'https://tsue-gatsby.web.app/'}
          target="_blank"
          rel="noopener noreferrer"
          className={styles.link}>
          作成者：津江明秀
